...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "treatme — scan your skin, match your treatment" },
      { property: "og:description", content: "scan your skin, see every concern on your face, then match with verified aesthetics providers and treatments near you." },
