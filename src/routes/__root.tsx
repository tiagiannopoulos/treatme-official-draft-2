...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "treatme | skin analysis and medspa treatment booking" },
      { name: "description", content: "scan your skin free, see what's actually going on, and book the treatment for it at a verified medspa. botox, filler, lasers and more, matched to your skin." },
      { property: "og:site_name", content: "treatme" },
      { property: "og:title", content: "treatme | skin analysis and medspa treatment booking" },
      { property: "og:description", content: "scan your skin free, see what's actually going on, and book the treatment for it at a verified medspa. botox, filler, lasers and more, matched to your skin." },
